...
variables()
{
        ...
        reconnectdelay1 = 1000   ;reconnect delay on halftime
        lobby = 1
        loading  = 0
        win = 0
        script = 0
  ...
  while ( teamwin <= rounds )
                    {
                        ...
                        OutputDebug wins = %wins% and fixscore %fixscore%
                        }
                        else
                        {
                          reconnectdelay2 := reconnectdelay
                             ...
                             while(ElapsedTime < rounddelay )
                                {
                                  ...
                                  if (t = "no" and ElapsedTime > rounddelay * 0.30)
...
Run	c:\Program Files (x86)\Steam\Steam.exe  -login %ha%	-applaunch 730 -silent -safe -windowed -novid -low -nojoy -noaafonts -nosound -threads 1 -dxlevel 80  +r_rootlod 2 -16bpp -nocrashdialog -h 480 -w 640 %p%
	sleep 5000
		i++
		;if (i = 11)
		;i = 1
