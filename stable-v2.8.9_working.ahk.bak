...
SetMouseDelay, 300
!p::Pause
F4::OutputDebug %matchcount% done till ac num %set% , mode %mode1%
F6::play_160()
;F6::play_1515()
F7::changeaccs()
F8::tenaccopen()
...
ImageSearch, FoundX, FoundY, 0, 0, 3200, 960, *5 ok.png
  ...
  Click, %X%, %Y%
    ...
    ImageSearch, FoundX, FoundY, 0, 0, 3200, 515, *10 network_error.png
    ...
    Text2:="|<>*190$21.zzzwFssRyyrrjjzBZvxqr0+67zzzU"
      timer = 0
      while (ErrorLevel = 0)
    ;while (ok:=FindText(1280, 480, 1280, 480, 0, 0, Text) or ok:=FindText(1280, 480, 1280, 480, 0, 0, Text1) or ok:=FindText(1280, 480, 1280, 480, 0, 0, Text2) or (ErrorLevel = 0))
      {
      timer++
      X:=ok.1.1, Y:=ok.1.2, W:=ok.1.3, H:=ok.1.4, Comment:=ok.1.5, X+=W//2, Y+=H//2
      ;y := y + 15
      ...
      sleep 3000
          ...
          if (ok:=FindText(1224, 1157, 1000, 1000, 0, 0, Text3))
            {
              X:=ok.1.1, Y:=ok.1.2, W:=ok.1.3, H:=ok.1.4, Comment:=ok.1.5, X+=W//2, Y+=H//2
              ;MouseClick, left,x,y
              ;timer = 50
      ...
      ImageSearch, FoundX, FoundY, 0, 0, 3200, 960, *2 network_error.png
...
if (ok:=FindText(2103, 1191, 1000, 1000, 0, 0, Text))
{ 
  X:=ok.1.1, Y:=ok.1.2, W:=ok.1.3, H:=ok.1.4, Comment:=ok.1.5, X+=W//2, Y+=H//2
...
Text:="|<play_game>*134$58.3jvTTbvrq1qzKvxjLCPrPxRTjxQtj3jivylipK1yy3jvq3JPrvvizqvhJjTUTPzbTKq2"
while (ok:=FindText(2103, 1191, 1000, 1000, 0, 0, Text))
{ 
  X:=ok.1.1, Y:=ok.1.2, W:=ok.1.3, H:=ok.1.4, Comment:=ok.1.5, X+=W//2, Y+=H//2
  MouseClick, left,%X%, %Y%,1,50,,
  sleep 500
...
Text1:="|<play_game>*134$58.3jvTTbvrq1qzKvxjLCPrPxRTjxQtj3jivylipK1yy3jvq3JPrvvizqvhJjTUTPzbTKq2"
if (ok:=FindText(2103, 1191, 1000, 1000, 0, 0, Text1))
{ 
  X:=ok.1.1, Y:=ok.1.2, W:=ok.1.3, H:=ok.1.4, Comment:=ok.1.5, X+=W//2, Y+=H//2
  MouseClick, left,%X%, %Y%,1,50,,
  sleep 500
