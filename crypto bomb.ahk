...
;if (ok:=FindText(0, 0, 1920, 1080, 0.02, 0.02, Text))
  ;  {
  ;     OutputDebug yea
 ;   }
...
Text:="|<connect_wallet>0xFFFFFF@1.00$47.0000000000000000Dk007zzsTU00Dzzkz000TzzVy000z003w001y007s003w00Dk007s00TU00Dk00z000Tzs1y000zzk3w001zzU7s003zz0Dk007s00TU00Dk00z000TU01y000z003w001y007zzk3zzwDzzk7zzsTzzUDzzkzzz0TzzU000000000000001"
...
Text:="|<ok_error>0xFFFFFF@1.00$32.zzky3y1wDVzUD3sTs3kyTy0wDbnUD3zws3kzwC0wDz3UD3zws3kyTC0wDbzUD3sTs3ky7y0wDUTUT3s3zzky0s"
 if (ok:=FindText(0, 0, 1920, 1080, 0, 0, Text))
 {
    ...
    Text:="|<select meta mask>0xC3C3C3@1.00$31.3zzwDVzzy7kzzz3sM71V0810E24E2033UEQ1V0800k27U08108040100U40k8MU"
    if (ok:=FindText(0, 0, 1920, 1080, 0, 0, Text) or ok:=FindText(0, 0, 1920, 1080, 0, 0, Text2 ))
    {
        X:=ok.1.x, Y:=ok.1.y
           Click, %X%, %Y%
            Sleep 4000
    ...
    Text:="|<loadingscreen>0x150F1B@1.00$16.kA30k0300A00000000000k03w0z00A00000000000k0300A30kC"
    loadingtime = 0
    while (ok:=FindText(0, 0, 1920, 1080, 0, 0, Text))
    {
        ...
        sleep 1000
        loadingtime++
        if (loadingtime = 60 or breakme = 1)
        {
            loadingtime = 0
            send ^{f5}
            Sleep 5000
...
Text:="|<onrest>0x9DE4DE@0.96$17.0000007zsDzzU0T00U"
if (ok:=FindText(0, 0, 1920, 1080, 0.11, 0.25, Text))
{
    ...
    OutputDebug %howmanysleeping% sleeping & %MyTicks%/40 mins `n
    ;ElapsedTime = 900001
    if (howmanysleeping >= 7 and ElapsedTime > 2400000 ) ;40 mins
    {
        ...
        Text:="|<xy0_heroInfo>*152$55.7zzzzzzzzXzzzzzzzzm400000007m00000003t00000001z00000000zU0000000T00000000A000000006000000002"
        while(!ok:=FindText(0, 0, 1920, 1080, 0.02, 0.02, Text))
            Sleep 500
        ;VarSetCapacity(i,0)
       Text:="|<greenhealth>0x8DC1B7@1.00$3.rU"
        if (ok:=FindText(0, 0, 1920, 1080, 0, 0, Text))
