...
if (ok:=FindText(3055, 157, 15, 15, 0, 0, Text)) ; khrab krti purposefully
{
...
sleep 2000
                                  ...
                                  map_command := Clipboard
                                  sleep 200
                                  IniWrite, %Clipboard% mg_cs_agency , C:\Program Files (x86)\Steam\steamapps\common\Counter-Strike Global Offensive\csgo\cfg\test1.cfg,echo ,
                                  SendRaw,`quit
                                  sleep 200
                                  send {enter}
                                  sleep 2000
