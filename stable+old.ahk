...
play_pr2()
  {
    ...
    Loop
          ...
          while ( ElapsedTime <= 2400000  and total_pr2_done < total_accounts_open)
                    {
                      ImageSearch, FoundX, FoundY, 0, 0, 3200, 1440, *5 ok.png
                      while (ErrorLevel = 0)
                                {
                                  x :=  FoundX 
                                  y :=  FoundY
                      ...
                      IniRead,total_pr2_done,pr2.ini,current,total_pr2
                    }
          pr1_users()
          newchangeaccs()
          make_pr2_ini()
...
newchangeaccs()
  {
    ...
    tx1 = 33
    ty1 = 350
    ;; Text:="|<xp_bar>*72$8.zs2zgvCngvCngvCngvCngvCzUDy"
    xc = 640
    yc = 480
    sx1 := sx1
    sx2 := sx1 + xc
    ...
    while (x = 0 && wait_time < 600000 )
      ...
      sleep 10000
      tenaccopen_check()
      Run, %A_ScriptDir%\IrfanView\i_view64.exe /capture=1 /convert=rank\rank.png
      write_value()
      ;matchcount = matchlimit++
      ;print()
      ;changeaccs()
