...
Loop
{
FileReadLine, ha,wins.txt, %Index%
if (ErrorLevel = 1)
{
Pause
}
...
{
Run	c:\Program Files (x86)\Steam\Steam.exe  -login %ha%	-applaunch 730 -windowed -novid -low -nobootstrapupdate -nocache -noaafonts -nosound -threads 6 -nocache -d3d9ex -nocrashdialog -h 1080 -w 1920
}
  MouseMove, 570, 430

Loop
{
Text:="|<>*132$32.y3zw7zUzz1zUDzk7k1zs0s0Dw0701y03k0000y0000TU0007wA033zjU1xzzw0zzzz0Dzzzk3zzzw0zzzzzzzs"
if (ok:=FindText(1008, 1076, 1000, 1000, 0, 0, Text))
{
  CoordMode, Mouse
  break
}
...
sleep 1000
Text:="|<go>*130$10.00000yy2PdWbvk002" ;csgo
Loop
{
Text:="|<go>*130$10.00000yy2PdWbvk002" ;csgo
if (ok:=FindText(560, 430, 1000, 1000, 0.1, 0.1, Text))
{
  CoordMode, Mouse
...
{
	Text:="|<lib>*104$29.zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz01lza01XyATXXsszXbnlz777XyT4T7sz9y03y3w0TyDswTwTlwTszXwTlz7szXyDsz7wTsyDzzzzzzzzzzzzzzz"

if (ok:=FindText(772, 249, 1500, 1500, 0, 0, Text))
{
  CoordMode, Mouse
  X:=ok.1.1, Y:=ok.1.2, W:=ok.1.3, H:=ok.1.4, Comment:=ok.1.5, X+=W//2, Y+=H//2
   Click, %X%, %Y%
...
Text:="|<i>*130$71."

Loop
{
if (ok:=FindText(2558, 784, 1000, 1000, 0, 0, Text))
{
  CoordMode, Mouse
  X:=ok.1.1, Y:=ok.1.2, W:=ok.1.3, H:=ok.1.4, Comment:=ok.1.5, X+=W//2, Y+=H//2
  MouseMove, %X%, %Y%
...
Text:="|<down>*113$16.zzyDwETVUw71Uy07w0zs7zkzzbzzzs"
Loop
{
if (ok:=FindText(2558, 784, 1000, 1000, 0, 0, Text))
{
...
OutputDebug num "%index%" user "%ha%"
sleep 500
Run, %A_ScriptDir%\IrfanView\i_view64.exe /capture=0 /convert=wins\%index%.png
sleep 500
RunWait killsteam1.bat
sleep 1500
RunWait killsteam1.bat
Index++
} ; loop
...
print()
{
ifnotexist, wins   ; Location Of The Saved Capture
fileCreateDir, wins   ; Location Of The Saved Capture
Run, %A_ScriptDir%\IrfanView\i_view64.exe /capture=0 /convert=wins\%index%_%ha%.png
