...
{ 
    ...
    while (ErrorLevel = 0)
    {
        ...
        MouseClick, left, FoundX, FoundX ,,10
        MouseMove, 20, 40, 10, R
        ImageSearch, FoundX, FoundY, 0, 0, 3200, 960, *5 ok.png
    }
    reconnect_r:="|<reconnect>*153$27.000W16F4F0H8006F0180004"
...
{ 
    ...
    if ( lobbycount >= 1 && lobbycount <= 3 && swap_accs != 1)
    {
        ...
        if (ok.maxindex() != 5)
        {
            ...
            Sleep 600
            nearby:="|<nearby>*91$20.y40S003300X809m00QU0D80Dk03y01VuTsz7y13zU1zznzy"
            if(ok:=FindText(3100, 100, 3200, 240, 0, 0, nearby))
            Sleep 100
            X = 3138
            Y:=ok.1.2
            Click, %x%, %Y%
        ...
        if (ok.maxindex() != 5)
        {
            ...
            Sleep 400
            nearby:="|<nearby>*91$20.y40S003300X809m00QU0D80Dk03y01VuTsz7y13zU1zznzy"
            if(ok:=FindText(3100,550, 3200, 680, 0, 0, nearby))
                Sleep 200
            X:=ok.1.1, Y:=ok.1.2
            Click, %X%, %Y%
...
superinv()
{
     ...
     if (ok2:=FindText(320, 0, 2580, 580, 0, 0, notinlobby))
    {
        ...
        ;******************************************************************************************
             msg:="|<msg>0xF8F8F8@1.00$14.001zU7kEkb0tsSTzbzs00U"
     ,inv_window:="|<inv_window>*128$12.sTkDkDkDsTzvU3000003zvU"
    SetMouseDelay, 35
...
mode_change()
{
    ...
    outputDebug matchlimit>%matchlimit%, do1614>%do1614%
}
crash_check()
{
    ;odebug = crash check
