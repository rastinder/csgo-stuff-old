...
if (join = 1)
{
  ...
  Click, %X%, %Y%
    ...
    Text:="|<network>*171$25.zzzzsFkkxnfvAtVtqTAUvDqMNk0UVzzzzs"
    if (ok:=FindText(1280, 480, 1280, 480, 0, 0, Text))
    {
    while (ok:=FindText(1280, 480, 1280, 480, 0, 0, Text))
      {
