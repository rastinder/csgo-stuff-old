                              ...
                              while(ElapsedTime < rounddelay )
                                      {
                                        ...
                                        if (t = "no" and ElapsedTime > rounddelay * 0.8)
                                          {
                                              error()
                                              OutputDebug chk score %ElapsedTime%
                                              getteam()
                                                  runfuntion = 0
                                                  getscore()
                                                  runfuntion = 1
...
error()
    {   
        ...
        if (ErrorLevel = 0)
            {
           OutputDebug neterror pic found 
  ...
  {   
    ...
    if (matchcount = 0)
    ...
    else
      {
        ...
        if (ok:=FindText(3055, 157, 15, 15, 0, 0, Text) && matchcount != 0 && swap_accs = 0) 
          {
        ...
        {  
          ...
          while(i <= 10)
                    {	
                      ...
                      ;OutputDebug a=%a% ;"%sx% %sy% %tx% %ty%" "%clipboard%"
    ...
    if (my_mode = 16)
      {
        ...
        {
          OutputDebug t%gett% ct%getct%
          wins++
          OutputDebug wins %wins%++
        }
      }
        return
...
if ( tss >=14 and cts >=14) ;and (tss >=0 or cts >=0 )
  ...
  skiphftm = 1
OutputDebug `n rounds %total% mode %my_mode% `n
if (do1614 = 1)
  {
    if ( total >= 6)
      {
