...
check_rank( )
	  ...
	  Loop, Files, \\2700-pc\c\DLL\rank\*.png
	{
		...
		loop,10
		{
			...
			final = %nana1%,,%nana2%
			OutputDebug `n %final%
		TF_ReplaceLine(file_write1,indexing,indexing,final )
		indexing++
		}
