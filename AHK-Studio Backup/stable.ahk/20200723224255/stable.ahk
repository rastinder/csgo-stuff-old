...
Gui, Add, Text, vMyText21 cYellow, %A_UserName%,%A_ScriptDir%  ;XXxxxxxxxxxxxxxxxxxxxxXXX YYyyyyyyyyyyyyyyyyyyyyYYY  ; XX & YY serve to auto-size the window.
...
NumpadAdd::Pause
NumpadSub::print("imp")
F4::odebug = %matchcount% done till ac num %set%
F6::play_160()
;F6::play_1515()
F7::changeaccs()
F8::tenaccopen()
