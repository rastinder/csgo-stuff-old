...
CoordMode Mouse, Screen
 ...
 sx1 := "122"   ;t 
     ...
     Loop 1
		{	
			RunWait, Capture2Text\Capture2Text_CLI.exe --screen-rect "%sx1% %sy1% %tx1% %ty1%"  --clipboard ,,Hide
		...
		outputdebug  ct= cts"%cts%" copy"%clipboard%" real"%getct%" `n
        ...
        ,clipboard := a
          ...
          {
			RunWait, Capture2Text\Capture2Text_CLI.exe --screen-rect "%sx1% %sy1% %tx1% %ty1%"  --clipboard ,,Hide
           ; outputdebug  "%sx% %sy% %tx% %ty%" "%clipboard%" `n
 ...
 Loop{
	Sleep 60
PixelSearch, Px, Py, 320, 22, 320, 22, 0x4232EF, 74, Fast
if ErrorLevel
   OutputDebug, red `n
else
Pause ;OutputDebug, red X%Px% Y%Py%. `n

sleep 60
PixelSearch, Px, Py, 320, 22, 320, 22, 0xF1F0EF, 3, Fast
;if ErrorLevel
;  OutputDebug, white `n
;else
;    OutputDebug, white X%Px% Y%Py%. `n
i++
}
