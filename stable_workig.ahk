        ...
        if (ok:=FindText(1280, 480, 1280, 480, 0, 0, Text) or play_now = 1)
            {
                ...
                Run	c:\Program Files (x86)\Steam\Steam1.exe -single_core -login %ha% -applaunch 730 -silent -windowed -novid -nobootstrapupdate -nocache -nohltv -nominidumps -safe -refresh 30 -noforcemparms -nomsaa -clearbeta -nojoy -noaafonts -nosound -threads 1 -noshader  -d3d9ex -nocrashdialog -h 480 -w 640  -low
                Sleep 5000
                time_since_last_match := ""
                x = 0
                timer = 0
    ...
    loop
      {
        ...
        if (ErrorLevel = 1)
          ...
          { 
            ;Run	c:\Program Files (x86)\Steam\Steam.exe
            Run	C:\Program Files (x86)\Steam\steam.exe -single_core -login %ha% -applaunch 730 -silent -windowed -novid -nobootstrapupdate -nocache -nohltv -nominidumps -safe -refresh 30 -noforcemparms -nomsaa -clearbeta -nojoy -noaafonts -nosound -threads 1 -noshader  -d3d9ex -nocrashdialog -h 480 -w 640  %p% +exec test1.cfg -low 
            Start_Time := A_TickCount
        ...
        else
            {
              ...
              if (errorlevel = 0)
            ...
            else
                {
                  ...
                  p := pos%i%
                  ; Run	c:\Program Files (x86)\Steam\Steam.exe
                  Run	C:\Program Files (x86)\Steam\steam.exe -single_core -login %users% -applaunch 730 -silent -windowed -novid -nobootstrapupdate -nocache -nohltv -nominidumps -safe -refresh 30 -noforcemparms -nomsaa -clearbeta -nojoy -noaafonts -nosound -threads 1 -noshader  -d3d9ex -nocrashdialog -h 480 -w 640  %p% -low 
                  sleep  10000
                  timer = 0
                  ImageSearch, FoundX, FoundY, %sx%, %sy%, %tx%, %ty%, *50 tv.png     
                  while (errorlevel != 0)
              ...
              if (errorlevel = 0)
                {
                  ...
                  p := pos%i%
                   ;Run	c:\Program Files (x86)\Steam\Steam.exe
                  Run C:\Program Files (x86)\Steam\steam.exe -single_core -login %ha% -applaunch 730 -silent -windowed -novid -nobootstrapupdate -nocache -nohltv -nominidumps -safe -refresh 30 -noforcemparms -nomsaa -clearbeta -nojoy -noaafonts -nosound -threads 2 -noshader -d3d9ex -nocrashdialog -h 480 -w 640 %p% -low 
                  Sleep %delay%
                  StartTime := A_TickCount
                  ElapsedTime := A_TickCount - StartTime
                  de := delay/1000
