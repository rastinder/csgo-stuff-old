...
Sleep 100
    ...
    if ( loading = 1 )
  {
    ...
    if (time_since_last_match = "")
      Start_Time := A_TickCount
    timel_since_last_match := A_TickCount - Start_Time
...
Sleep 3000     
Run	c:\Program Files (x86)\Steam\Steam1.exe  -login %ha% -applaunch 730 -silent -windowed -novid -low -nobootstrapupdate -nocache -single_core -nohltv -nominidumps -nopreload -refresh 30 -noforcemparms -nomsaa -clearbeta -nojoy -noaafonts -nosound -threads 1 -Heapsize 4048576 -d3d9ex -nocrashdialog -h 480 -w 640
Sleep 5000
time_since_last_match := ""
x = 0
timer = 0
...
Run	c:\Program Files (x86)\Steam\Steam.exe  -login %ha%	-applaunch 730 -silent -safe -windowed -novid - low -nojoy -noaafonts -nosound -threads 1 -Heapsize 4048576 -dxlevel 90  +r_rootlod 2 -d3d9ex -nocrashdialog -h 480 -w 640 %p%
	sleep %delay%
		i++
		if (i = 11)
		;i = 1
...
;print()
		...
		p := pos%i%
Run	c:\Program Files (x86)\Steam\Steam.exe  -login %users%	-applaunch 730 -silent -windowed -novid -low -nobootstrapupdate -nocache -single_core -nohltv -nominidumps -nopreload  -refresh 60 -noforcemparms -nomsaa -clearbeta -nojoy -noaafonts -nosound -threads 1 -Heapsize 4048576 -d3d9ex -nocrashdialog -h 480 -w 640 %p%
	sleep  10000
    timer = 0
    ImageSearch, FoundX, FoundY, %sx%, %sy%, %tx%, %ty%, *50 tv.png     
    while (errorlevel != 0)
...
Run, %A_ScriptDir%\IrfanView\i_view64.exe /capture=0 /convert=ranks\set_%set%.match_%matchcount%_%A_TickCount%.png
