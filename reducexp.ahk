...
Text1:="|<73reduce_xp>0x6E963E@0.87$13.z06Uore9JRS04U"
Text2:="|<78reduce_xp>0x6FA132@0.86$13.v06EpneZJRS04U"
Text4:="|<78game_reduced>*90$42.kDzzzzzwrbzzzzu8LzzzzupLzzzzu27zzzzzzTzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzlzzQTTyq00J080m51I192k50J000U"

				Start_Time := A_TickCount
				wait_time := A_TickCount - Start_Time
;Text:="|<73reduce_xp>0x6E963E@0.87$13.z06Uore9JRS04U"
;Text:="|<reduce xp>0x699736@0.93$13.v0601neYJRS04U"
while (wait_time < 8000 )
{
	wait_time := A_TickCount - Start_Time
 if (ok:=FindText(0, 0, 3200, 960, 0, 0, Text4))
                  {
					X:=ok.1.1, Y:=ok.1.2, W:=ok.1.3, H:=ok.1.4, Comment:=ok.1.5, X+=W//2, Y+=H//2
					FindText_MouseTip(ok[1].x, ok[1].y)
					print("reduce_xp",A_UserName,1,"lan")
					break
					}
}
...
; Prompt mouse position in remote assistance
  ...
  ;-------------------------
		...
		print("reducexp","xp","1","lan")  ; folder,comment,repeat,location
