...
superinv()
{
    ...
    ;,notinlobby:="|<displaypic>*20$43.00000000000000000000000000000000000000000003zzzk007zzzy08"
    ,notinlobby:="|<displaypic>*20$40.U0000020000008000000U0000020000008000000U1zzzs20Tzzzs8"
    ,cancel_bt:="|<cancel_bt>*106$41.zzzzzzzzzzzzzzz7TslzzwAm10zztMU+Nzznp0Q3zzZ20dbzz2kUE3zzzzzzzzzzzzzzs"
     if (ok2:=FindText(450, 0, 2580, 580, 0.20, 0, notinlobby))
    {
        OutputDebug `n
...
single_inv()
{
    ...
    zz = 350
    msg:="|<msg>0xF8F8F8@1.00$14.001zU7kEkb0tsSTzbzs00U"
    Text:="|<displaypic>*20$40.U0000020000008000000U0000020000008000000U1zzzs20Tzzzs8"
...
newchangeaccs()
{
    ...
    loop
    {
        ...
        else 
        {
            ...
            Run,steam.exe %arguments% +exec %map_name%  -login %ha% %p% -low ,%steam_folder%,,steam_pid 
