...
Text:="|<genrate1>*157$71.k7zzzzzzzzDyDjzzzzzzzyTxzzzzzzzzzwzvzy7YDkwb1USDznb6CQsxlnnzzjaSRwnznbjw6TAwntbzbCTzA0NtU3DsCQ3yNznnDyTCQtvwnzbaTwwwtnrtXzDATtttnXbnbiSQxnnXbbkDUwww7bkbXV"
...
if (ok:=FindText(2023, 1080, 50, 1080, 0, 0, Text))
	{
		X:=ok.1.1, Y:=ok.1.2, W:=ok.1.3, H:=ok.1.4, Comment:=ok.1.5, X+=W//2, Y+=H//2
	Click, %X%, %Y%
		sleep 300
...
changevpn()
{
 ...
 Sleep 1000
  ...
  Sleep 500
 RunWait, D:\work stuff\platform-tools\adb.exe shell input tap 955 970
  Sleep 1500
   RunWait, D:\work stuff\platform-tools\adb.exe shell input tap 955 970
...
Text:="|<genrate2>*158$58.sDzzzzzzzzSzzzzzzxzvzzzzzzzrzTz7FwRAC75zvgninrRvbXSrhvTxrSTg3SkBy7Q1yrxvTrbRrvvTrhzSxrTbgrSnRvbQrVsRvVrlSMM"
