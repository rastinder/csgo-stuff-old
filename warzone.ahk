...
Text:="|<ok>*160$17.kQtCNYymPxVrt7jq7DgbCNb1nY"

 if (ok:=FindText(1286-150000, 261-150000, 1286+150000, 261+150000, 0, 0, Text))
 {
   CoordMode, Mouse
...
Text:="|<quit>*55$44.zzzztzzzUGGGGGHk0YYYYYswTzztzyS2GGE2HbUYYY0YtyNtttzyS2GGGGHbUYYYYYtaNtttzyM2GGGGHXUY4YYYw0s1tsTz022GG2HzYYYYYYzzzzzzzs"

 if (ok:=FindText(380-150000, 719-150000, 380+150000, 719+150000, 0, 0, Text))
 {
   CoordMode, Mouse
   X:=ok.1.x, Y:=ok.1.y, Comment:=ok.1.id
    Click, %X%, %Y%
...
Text:="|<yesssssss>*64$33.7tU3kQyA0Q1nnbzDaAwztwtbbzDzVwzsDwTU7UDnwzzkyTbzzbnwztwyTbzDbnw0Q1yTU3kQ"

 if (ok:=FindText(959-150000, 544-150000, 959+150000, 544+150000, 0, 0, Text))
 {
   CoordMode, Mouse
   X:=ok.1.x, Y:=ok.1.y, Comment:=ok.1.id
   Click, %X%, %Y%
...
Text:="|<battle>*78$71."

 if (ok:=FindText(157-1920, 238-1920, 157+1920, 238+1920, 0, 0, Text))
 {
   CoordMode, Mouse
   X:=ok.1.x, Y:=ok.1.y, Comment:=ok.1.id
   MouseMove, %X%, %Y%
...
Text:="<quad>*101$52.zzzzzzwzz0zzzzznzs1zzzzzDz7XzzzzwzwzAwy7sHUnwnnk70A1DnDCSNsnkzAwztbnDnwnnk6TC3CnDCCNww4tAwttbnz1knXbaSAwU70C0Q0k70C4w9sHUzyzzzzzzzU"
...
Text:="|<space>*148$57.DUzk60TUzvy7z1k7y7zkMkQD1kkk6361VMA360k0kANVU0k7k61XAA060DkkMFVU0zkD7y66A0600Mk0zlU0k6360DyA360kMk1UNkkk3y60A37y7zDUk30QTUzw"
 if (ok:=FindText(924-1920, 902-1920, 924+1920, 902+1920, 0, 0, Text))
 {
	loop, 5
	{
		send, {space}
...
Text:="|<in_game_ground>*148$35.zw30TlzsC0zsA0S1UkM0g31Uk3A631U6MAC308kTs60kkksA1zVUMM7z30kkA361VUM6Dy31UCTt"

 while (ok:=FindText(960-1920, 1039-1920, 960+1920, 1039+1920, 0, 0, Text))
 {
 leavegame = 1
	send, h
	send {shift}
...
Text:="|<f skip>*146$9.zzyk60k60zq0k60k60k4"
 spectating:="|<spectating>*144$21.000000000006300kM03600Ak01g007000s007001g00Nk03600kM0C3U00000000004"
 if (ok:=FindText(1658-150, 983-150, 1658+150, 983+150, 0, 0, Text))
 {
send, f
 }
 else   if (ok:=FindText(896-15, 1047-15, 896+15, 1047+15, 0, 0, spectating) and  leavegame = 1)
 {
	      send {esc} 
		  leavegame = 0
 }
...
Text:="|<leave game>*81$49.DzzzzzzzbzzzzzzznzzzzzzztzsDktwsAzs3kCSM2TtwnnCNwDwyTtbAy7y0C0ta03zDyCQbDtzbzDCHbwzntbbVns0Q1k3lw10D1w9sz1k"

 if (ok:=FindText(1476-1920, 803-1920, 1476+1920, 803+1920, 0, 0, Text))
 {
   CoordMode, Mouse
   X:=ok.1.x, Y:=ok.1.y, Comment:=ok.1.id
   Click, %X%, %Y%
...
Text:="|<leave game yes>*88$32.Dn07Unsk1k6SQztwXDDyTAnnzbzVwzsDsz0DUTDnzz3nwzzwwzDyTDDnzbnnw0Q1wz07Us"

 if (ok:=FindText(960-1920, 532-1920, 960+1920, 532+1920, 0, 0, Text))
 {
   CoordMode, Mouse
   X:=ok.1.x, Y:=ok.1.y, Comment:=ok.1.id
   Click, %X%, %Y%
...
Text:="|<inactive_exit>*89$38.06TCQ001bnb00zwttzDDzaSTnnztDbwwzz7tzD0DlyTnnzwTbwwzyHtzDDzASTnnznbbww0NwtzD04T6Tns"

 if (ok:=FindText(961-1920, 557-1920, 961+1920, 557+1920, 0, 0, Text))
 {
   CoordMode, Mouse
   X:=ok.1.x, Y:=ok.1.y, Comment:=ok.1.id
    Click, %X%, %Y%
...
Text:="|<ok>*83$23.kDbl0DD4SCSNyQtnwtbbtmDDnUSTb6QzCQtyQwlstsk3ntkDbt"

 if (ok:=FindText(372-1920, 696-1920, 372+1920, 696+1920, 0, 0, Text))
 {
   CoordMode, Mousef
   X:=ok.1.x, Y:=ok.1.y, Comment:=ok.1.id
    Click, %X%, %Y%
...
Text:="|<click>*154$16.sA70EQF3l4S4FsF1V464EMF7l4T4Fw17kAS"

 if (ok:=FindText(944-1920, 439-1920, 944+1920, 439+1920, 0, 0, Text))
 {
   CoordMode, Mouse
   X:=ok.1.x, Y:=ok.1.y, Comment:=ok.1.id
   Click, %X%, %Y%
...
;Text:="|<retry>*84$46.0TzzTzzw0TzwzzzntzznzzzDbUw3YbkyQ1kC3CHlbnntwt0CTDDbnYls0wyTYnbbzntyHDCTzDbwAwtwwyTlntk7ktz7DbUzXbyzzzzzzznzzzzzzwDzzzzzzly"
Text:="|<quit>*83$58.zzzzDzzzzz0zzxxzyzzs1zzznztzz7XzzzDzbzwzAwwkDs7Unwnnn0zUQ1DnDDDDzbbUzAwwwzyST3wnnnnzttwCnDDDDzbbktAwwwzyST1knXnnztttU70DD3zVk70C4wyDz7UzyzzzzzzzzU"

 if (ok:=FindText(385-192, 676-192, 385+192, 676+192, 0, 0, Text))
 {
   CoordMode, Mouse
   X:=ok.1.x, Y:=ok.1.y, Comment:=ok.1.id
    Click, %X%, %Y%
...
Text:="|<quit_yes>*82$32.Dn07Unsk1k6SQztwXDDyTAnnzbzVwzsDsz0DUTDnzz3nwzzwwzDyTDDnzbnnw0Q1wz07Us"

 if (ok:=FindText(960-150, 544-150, 960+150, 544+1500, 0, 0, Text))
 {
   CoordMode, Mouse
   X:=ok.1.x, Y:=ok.1.y, Comment:=ok.1.id
   Click, %X%, %Y%
...
Text:="|<sss>*58$71."

 if (ok:=FindText(1212-1920, 315-1920, 1212+1920, 315+1920, 0, 0, Text))
 {
   CoordMode, Mouse
   X:=ok.1.x, Y:=ok.1.y, Comment:=ok.1.id
   Click, %X%, %Y%
...
Text:="|<sss>*151$65."

 if (ok:=FindText(950-1920, 648-1920, 950+1920, 648+1920, 0, 0, Text))
 {
   CoordMode, Mouse
   X:=ok.1.x, Y:=ok.1.y, Comment:=ok.1.id
   Click, %X%, %Y%
 }
 Text:="|<unlock>*86$71."

 if (ok:=FindText(736-150, 419-150, 736+150, 419+150, 0, 0, Text))
 {
Text:="|<back>*84$71."

 if (ok:=FindText(154-150, 1043-150, 154+150, 1043+150, 0, 0, Text))
 {
 ...
 sleep 1000
Text:="|<pass page>0xFFD661@0.96$12.060D0SMwxsTkDU7020U"

 if (ok:=FindText(336-150, 749-150, 1636+150, 749+150     , 0, 0, Text))
 {
Text:="|<back>*84$71."

 if (ok:=FindText(154-150000, 1043-150000, 154+150000, 1043+150000, 0, 0, Text))
 {
...
;Text:="|<no_thanks>*101$63.zzbzzzztzzs0QzzzzzDzz03bzzzztzzzbwzzzzzDzzwzYDUwVttkTbw0s7U7CQ1wzXaSQQtbbbbwwznbb9wzwzbb0QwsDkTbwwlnbb0zVwzbaSQwtbzbbwwnnbbCQwwzba0QwtlUDbwwsHbbDC3U"
;Text:="|<no_thanks>*81$22.DnzwTDzkwzz3nsAbD0GAtsAnbktCT3UtwD3bkyCSHsw1DnsC"

; if (ok:=FindText(451-1920, 746-1920, 451+1920, 746+1920, 0, 0, Text))
 ;{
  ; CoordMode, Mouse
   ;X:=ok.1.x, Y:=ok.1.y, Comment:=ok.1.id
    ;Click, %X%, %Y%
...
Text:="|<quit>*139$40.kDDnb020QzCQ01snwtzDDnDnbwwzAzCTnnwnwtzDDnDnbwwzAzCTnngnwtzDCHDnbwwQAySTns1s1tzDk3kDbwzzjzzzzs"

 if (ok:=FindText(901-190, 558-190, 901+190, 558+190, 0, 0, Text))
 {
   CoordMode, Mouse
   X:=ok.1.x, Y:=ok.1.y, Comment:=ok.1.id
    Click, %X%, %Y%
...
Text:="|<play_mw>*167$71."

 if (ok:=FindText(1328-150, 562-150, 1328+150, 562+150, 0, 0, Text))
 {
   CoordMode, Mouse
   X:=ok.1.x, Y:=ok.1.y, Comment:=ok.1.id
   Click, %X%, %Y%
