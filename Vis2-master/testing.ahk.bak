...
box1 :=ocr([sx1,sy1,l,b])
box2 :=ocr([sx2,sy1,l,b]) 
box3 :=ocr([sx3,sy1,l,b]) 
box4 :=ocr([sx4,sy1,l,b]) 
box5 :=ocr([sx1,sy2,l,b]) 
box6 :=ocr([sx2,sy2,l,b]) 
box7 :=ocr([sx3,sy2,l,b]) 
box8 :=ocr([sx4,sy2,l,b]) 
box9 :=ocr([sx5,sy1,l,b]) 
box10 :=ocr([sx5,sy2,l,b]) 

OutputDebug up|%box1%| |%box2%| |%box3%| |%box4%| |%box9%|
OutputDebug dn|%box5%| |%box6%| |%box7%| |%box8%| |%box10%|
sleep 200
